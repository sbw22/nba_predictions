...
class CollectGameAndPlayerData:
    ...
    def get_player_data(self):
        ...
        test_players_df = self.get_targeted_data(2024, 2025, 'LeagueDashPlayerStats')
        ...
        test_games_df = self.get_targeted_data(2024, 2025, 'LeagueGameLog')
        ...
        train_teams_df = self.get_targeted_data(2024, 2025, 'LeagueDashTeamStats')
